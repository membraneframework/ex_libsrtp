...
static const char *srtp_strerror(srtp_err_status_t err) {
  switch (err) {
...
static UnifexPayload *unifex_payload_clone_ex(UnifexEnv *env,
                                              UnifexPayload *original,
...
static UnifexPayload *unifex_payload_clone(UnifexEnv *env,
                                           UnifexPayload *original) {
