defmodule SRTPTest do
  ...
  test "protect and unprotect rtcp" do
    ...
    assert :ok = SRTP.add_stream(srtp, policy)
    ...
    assert {:ok, protected} = SRTP.protect_rtcp(srtp, rtcp)
    ...
    assert {:ok, unprotected} = SRTP.unprotect_rtcp(srtp, protected)
