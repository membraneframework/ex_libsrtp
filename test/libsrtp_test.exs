defmodule ExLibSRTPTest do
  ...
  test "protect and unprotect rtcp" do
    ...
    assert :ok = ExLibSRTP.add_stream(srtp, policy)
    ...
    assert {:ok, protected} = ExLibSRTP.protect_rtcp(srtp, rtcp)
    ...
    assert {:ok, unprotected} = ExLibSRTP.unprotect_rtcp(srtp, protected)
